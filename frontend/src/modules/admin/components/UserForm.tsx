...
export const UserForm = ({ onClose, onSuccess, userToEdit }: Props) => {
  ...
  const handleRoleChange = (newRole: string) => {
      // Si eligen el placeholder vacío, limpiamos el área
      if (!newRole) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Validación extra: Rol obligatorio
    if (!formData.role) {
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select
                                ...
                                disabled={!formData.role} // <--- Deshabilitado si no hay rol
                            >
                                {!formData.role ? (
                        ...
                        <div className="col-span-2">
                            ...
                            <div className="relative">
                                ...
                                <select name="career" value={formData.career} onChange={handleChange} className="form-input pl-10 cursor-pointer">

  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-slate-950 pb-20 animate-fade-in">
      ...
      <div className="container mx-auto px-6 -mt-8 relative z-20 max-w-5xl">
        ...
        {loading ? (
            <div className="text-center py-20 text-gray-500">Cargando convocatorias...</div>
        ) : scholarships.length === 0 ? (
            <div className="card-base p-16 text-center text-gray-500 shadow-xl">
            ...
            <div className="grid gap-8">
                {scholarships.map(beca => {
                    ...
                    const isActiveDate = now <= endDate;
                                ...
                                <div className="p-8 flex-1">
                                    <div className="flex flex-col md:flex-row justify-between items-start gap-4 mb-4">
                                        <div>
                                            ...
                                            <h3 className="text-2xl font-bold text-gray-900 dark:text-white group-hover:text-guinda-600 transition-colors">
                                                {beca.name}
                                            </h3>
                                        </div>
                                        ...
                                        <div className="shrink-0">
                                            {isActiveDate ? (
                                                <div className="text-right">
                                                    <span className="block text-green-600 font-bold text-sm uppercase tracking-wide">Convocatoria Abierta</span>
                                    ...
                                    <div className="flex flex-col md:flex-row items-center justify-between border-t border-gray-100 dark:border-slate-800 pt-6 gap-4">
                                        <div className="text-sm text-gray-500 flex flex-col md:flex-row gap-4">
                                            <span className="flex items-center gap-2">
                                                <Calendar size={16} className="text-guinda-600" />
                                                <strong>Resultados:</strong> {formatDate(beca.results_date)}
                                            </span>
                                            <span className="flex items-center gap-2">
                                                <FileText size={16} className="text-blue-600" />
                                                <strong>Requisito:</strong> Formato PDF + Documentos
                                            </span>
                                        </div>

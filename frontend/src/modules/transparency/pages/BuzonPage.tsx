  ...
  if (success) {
      return (
          <div className="min-h-screen bg-gray-50 dark:bg-slate-950 flex items-center justify-center p-6 animate-fade-in">
              <div className="card-base max-w-lg w-full p-10 text-center shadow-2xl dark:shadow-none border dark:border-slate-800">
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-slate-950 pb-20 animate-fade-in">
      ...
      <div className="bg-slate-900 text-white py-16 px-6 text-center relative overflow-hidden">
        <div className="absolute top-0 right-0 w-96 h-96 bg-guinda-600 rounded-full blur-3xl opacity-20 -mr-20 -mt-20 pointer-events-none"></div>
      ...
      <div className="container mx-auto max-w-3xl px-6 -mt-10 relative z-20">
        <div className="card-base p-8 md:p-10 shadow-2xl dark:shadow-none dark:border dark:border-slate-800">
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="col-span-2">
                            ...
                            <input name="full_name" required value={formData.full_name} onChange={handleChange} className="form-input" placeholder="Tu nombre completo" />
                        </div>
                        <div>
                ...
                <div className="space-y-6">
                    ...
                    <div>
                        ...
                        {/* 👇 ÁREA DE UPLOAD MEJORADA PARA DARK MODE */}
                        <label className={`
                        ...
                        `}>
                            ...
                            <div className="text-center md:text-left">
                                <span className={`font-semibold block ${uploading ? 'text-gray-500' : 'text-gray-700 dark:text-gray-200 group-hover:text-guinda-700 dark:group-hover:text-guinda-400'}`}>
                                    {uploading ? 'Subiendo archivo...' : (formData.evidence_url ? 'Cambiar archivo seleccionado' : 'Haz clic para seleccionar archivo')}
                                </span>
                                {!uploading && (
                        ...
                        {formData.evidence_url && !uploading && (
                            <div className="mt-3 flex items-center gap-2 text-sm text-green-600 dark:text-green-400 bg-green-50 dark:bg-green-900/20 px-4 py-2 rounded-lg w-fit animate-fade-in">
                                <CheckCircle size={16} />
                                <span>Evidencia cargada correctamente</span>
                            </div>
                        )}
                    </div>
                </div>
                ...
                <div className="bg-amber-50 dark:bg-amber-900/10 border border-amber-100 dark:border-amber-900/20 p-6 rounded-xl flex items-start gap-4">
                    <AlertCircle className="text-amber-600 dark:text-amber-500 mt-1 shrink-0" size={24} />
                    <div className="text-sm text-amber-800 dark:text-amber-400 space-y-2 text-justify leading-relaxed">
                ...
                <button
                    ...
                    className="btn-primary w-full py-4 text-lg shadow-lg shadow-guinda-900/20 flex items-center justify-center gap-2 hover:scale-[1.01] transition-transform"
                >
                    {loading ? 'Enviando...' : (
